...
brickpi3.set_address(3,
                     "192A0F96514D4D5438202020FF080C23")  # set BrickPi3 with serial number ID "192A0F96514D4D5438202020FF080C23" to address 3
brickpi3.set_address(4, "84FBCC9D514D4D5439202020FF0E070F")

try:
    BP3_2 = brickpi3.BrickPi3(
        2)  # Create an instance of the BrickPi3 class. BP3_2 will be the BrickPi3 object for the BrickPi3 with address 2.
    BP3_3 = brickpi3.BrickPi3(
        3)  # Create an instance of the BrickPi3 class. BP3_3 will be the BrickPi3 object for the BrickPi3 with address 3.
