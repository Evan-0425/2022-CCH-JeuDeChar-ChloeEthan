...
BP.set_sensor_type(GPS_PORT, BP.SENSOR_TYPE.I2C, [BP.SENSOR_I2C_SETTINGS.MID_CLOCK,
                                                  0])  # Configure for a Dexter Industries GPS (I2C device with clock pulse between the write and read bytes).
...
#             if value[
#                 0] > 10:  # if the 0th byte >10, then the longitude was negative and use the 2's compliment of the longitude
...
#
#             print('Status', status, 'UTC', UTC, 'Latitude %.6f' % lat, 'Longitude %.6f' % lon, 'Heading', head,
#                   'Velocity', velo, 'Altitude', altitude, 'HDOP', hdop, 'Satellites in view', satv)
#
