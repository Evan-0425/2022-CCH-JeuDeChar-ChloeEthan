...
BP.set_sensor_type(BP.PORT_1, BP.SENSOR_TYPE.CUSTOM, [
    (BP.SENSOR_CUSTOM.PIN1_ADC)])  # Configure for a Dexter Industries pressure sensor (analog on sensor pin 1).
    ...
    while True:
        ...
        try:
            ...
            if (value < 4095):  # if the value is < 4095, the sensor is connected
                print(
                    "Pressure: %6.2fkPa" % (((value / 4095) - 0.04) / 0.0018))  # print the value for the dPressure 500
